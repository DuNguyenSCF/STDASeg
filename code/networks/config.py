...
_C.MODEL.TYPE = 'swin'
# Model name
_C.MODEL.NAME = 'swin_tiny_patch4_window7_224' #'swin_tiny_c24_patch4_window8_256' # 'swin_tiny_patch4_window7_224'
...
# _C.MODEL.SWIN.NUM_HEADS = [4, 8, 16, 32] # for size 256 
