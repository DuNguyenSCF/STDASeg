...
def add_train_CTCT_args(arg_parser):
    ...
    arg_parser.add_argument('--exp', type=str,
                        default='C2C_compared_SSLs_CTCT/CTCT_FPIE_50000iters_bs8', help='Experiment_name')
    arg_parser.add_argument('--cnn_model', type=str,
                        default='unet_mod', help='Model_name')
...
def initialize_CTCT_train_args():
    arg_parser = argparse.ArgumentParser()
    arg_parser = add_train_CTCT_args(arg_parser)
    args = arg_parser.parse_args("")
    return args

def add_test_SSLs_args(test_arg_parser):
