...
from encoder_vggnet import vgg_encoders
from encoder_senet import senet_encoders
# from .densenet import densenet_encoders
# from .inceptionresnetv2 import inceptionresnetv2_encoders
# from .inceptionv4 import inceptionv4_encoders
from encoder_efficientnet import efficient_net_encoders
from encoder_mobilenet import mobilenet_encoders
# from encoder_xception import xception_encoders
...
from encoder_mix_transformer import mix_transformer_encoders
...
def get_encoder(name, in_channels=3, depth=5, weights=None, output_stride=32, **kwargs):
    ...
    if weights is not None:
        ...
        # encoder.load_state_dict(torch.hub.load(settings["url"], 'nvidia_se_resnext101_32x4d'))
